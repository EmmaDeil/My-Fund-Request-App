...
}/#/approve/${mockFundRequest.approvalToken}`;
...
const url2 = `${
  process.env.FRONTEND_URL || "https://my-fund-request-app.onrender.com"
}/#/approve/${mockFundRequest.approval_token}`;
...
console.log("\n🎯 SUMMARY:");
const allHaveHash = [url1, url2, url3].every((url) =>
...
if (allHaveHash) {
  ...
  console.log(
    "📧 Next fund request emails will include working approval links!"
  );
} else {
